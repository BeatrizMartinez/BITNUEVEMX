...
(function ($) {
    ...
    Calendar.prototype._update_month = function () {
        ...
        self.context.find('a.event').mouseenter(function () {            
            $('a[data-event-id="' + $(this).data('event-id') + '"]').closest('.cal-cell1').css({"background-image": "url('" + $(this).data('event-cla') + "')", "background-size": "100% 100%", "background-repeat": "no-repeat"});//.addClass('day-highlight dh-' + $(this).data('event-class'));                        
        });
        self.context.find('a.event').mouseleave(function () {            
            $('div.cal-cell1').css({"background-image": "", "background-size": "", "background-repeat": ""});
